  ...
  <section id="skills" className="py-20 bg-gray-100 dark:bg-gray-800">
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1  md:grid-cols-2 gap-10 ">
        <div className=" bg-white dark:bg-gray-700 shadow-md p-5 rounded-lg w-[500px]">
          <span className="text-fuchsia-500">FrontEnd</span>
        ...
        <div className=" w-[300px] bg-white dark:bg-gray-700 shadow-md p-5 rounded-lg">
          ...
          <span className="text-fuchsia-500">ETC</span>
          <div className="grid grid-cols-1  gap-8">
